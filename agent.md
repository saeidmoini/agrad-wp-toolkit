...
- Security submenu must backup iptables before applying rules that restrict SSH 2244, DirectAdmin 8956, MySQL 3306 (plus localhost), FTP 21 (plus localhost), and LiteSpeed admin 7080 to allowed IPs; provide add/remove/list/apply/disable/restore helpers. Disable option removes all AGRAD firewall chains and restores unrestricted access (safety feature to prevent lockouts).
